    ...
    for cost in ("self_cost", "harm_other"):
        for dose in (0, 2, 4, 6, 8):
            ...
            print(f"{name:8s} {cost:10s} dose {dose:+d}: "
                  ...
                  flush=True)
handle.remove()
json.dump(rows, open(OUT / "saw_button_v3_broad.json", "w"), indent=1)
...
fig.savefig(OUT / "saw_button_v3_broad.png", facecolor="#050508",
            bbox_inches="tight")
print("wrote", OUT / "saw_button_v3_broad.png")